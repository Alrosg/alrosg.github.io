...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "洛水的后花园", // 主页横幅主标题

			subtitle: ["喵喵喵","Ciallo～ (∠・ω< )⌒★"],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
               {
					name: "GitHub",
					url: "https://github.com/Alrosg/alrosg.github.io",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1492451167",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Alrosg",
		},
	],
	// Umami统计部份，记得在layout插入Umami的head标签
	umami: {
		enable: false, // 是否显示umami统计
		shareId: "L4qL2Aaey8Ym5v2A", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	width: 280, // 默认宽度
	height: 250, // 默认高度
	mode: "fixed", // 默认为可拖拽模式'draggable'为可拖拽,'fixed'为不可拖拽
	hiddenOnMobile: true, // 默认在移动设备上隐藏
	dialog: {
		welcome: "欢迎来到我的个人博客ฅ( ̳• · • ̳ฅ)", // 欢迎词
		touch: [
			"你在做什么？",
			"不要碰我！",
			"不要这样欺负我！",
		...
		home: "点击这里返回首页！", // 首页提示
		skin: ["想看我的新衣服吗", "这套新衣服看起来真不错~"], // 换装提示
		close: "QWQ 下次见~", // 关闭提示
		link: "https://github.com/Alrosg/", // 关于链接
	},
};
